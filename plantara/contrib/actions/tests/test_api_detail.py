...
class ActionDetailTestCase(APITestCase, TestMixin):
    ...
    def test_get(self):
        ...
        expected_response = {
            ...
            "type": response.wsgi_request.build_absolute_uri(reverse("actiontype-detail", args=[action.type.pk])),
            "plant": response.wsgi_request.build_absolute_uri(reverse("plant-detail", args=[action.plant.pk])),
            "notes": action.notes,
